<footer class="footer justify-self-end mt-auto footer-center p-10 bg-gray-800 text-primary-content">
  <div >
    ...
    <p class="font-bold">
       TPQ Khoirul Huda <br/>{{-- Providing reliable tech since 1992 --}}
    </p> 
